...
<main>
    <!--? Hero Start -->
    <div class="">
                        <script src="imtucewe24.js"></script>
                        <br>
                        <br>
                        <br>
                        <br>
...
<h2>Kalkulator Otomatis Indeks Masa Tubuh Menurut Umur Anak Perempuan</h2>
<br>
                        <img src="../../gis/indeksmasatubuhmenurutumur.png"  id="zscorebbu" alt="">
                        <br>
                        <style>
                            #zscorebbu{
...
h2{
    ...
    <a href="imtucewe24.php" id="tombol">Hitung Lagi</a>
