...
<main>
    <!--? Hero Start -->
    <div class="">
                        <script src="tbulaki24.js"></script>
                        <br>
                        <br>
                        <br>
                        <br>
...
<h2>Kalkulator Otomatis Tinggi Badan Menurut Umur Anak Laki-Laki</h2>
<br>
                        <img src="../../gis/tinggibadanmenurutumur.png"  id="zscorebbu" alt="">
                        <br>
                        <style>
                            #zscorebbu{
...
h5{
    ...
    <a href="tbulaki24.php" id="tombol">Hitung Lagi</a>
