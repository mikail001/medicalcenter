...
<aside class="main-sidebar fixed offcanvas shadow">
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="formlaki.php"><i class="icon icon-wpforms green-text s-18"></i>Posyandu Mekar Arum 17</a>
            </li>
...
<div class="page has-sidebar-left height-full">
    ...
    <form method="post" action="tambahaksi.php">
        ...
        <div class="user-box">
          <input type="text" id="zsbbu" required="" name="zsbbu">
          <label>Z-Score Berat Badan Menurut Umur</label>
        </div>
        <div class="user-box">
          <input type="text" id="statusbbu" required="" name="StatusGiziBB">
          <label>Status Gizi Berdasarkan Berat Badan Menurut Umur</label>
        </div>
        <div class="user-box">
          <input type="text" id="zstbu" required="" name="zstbu">
          <label>Z-Score Tinggi Badan Menurut Umur</label>
        </div>
        <div class="user-box">
          <input type="text" id="statustbu" required="" name="StatusGiziTB">
          <label>Status Gizi Berdasarkan Tinggi Badan Menurut Umur</label>
        </div>
        <div class="user-box">
          <input type="text" id="zsimtu" required="" name="zsimt">
          <label>Z-Score Indeks Masa Tubuh Menurut Umur</label>
        </div>
        <div class="user-box">
          <input type="text" id="statusimtu" required="" name="StatusGiziIMT">
