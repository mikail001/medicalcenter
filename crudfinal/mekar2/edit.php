...
<aside class="main-sidebar fixed offcanvas shadow">
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="formlaki.php"><i class="icon icon-wpforms green-text s-18"></i>Posyandu Mekar Arum 2</a>
            </li>
            <li><a href="../mekar3/formlaki.php"><i class="icon icon-wpforms blue-text s-18"></i>Posyandu Mekar Arum 3</a>
            </li>
            ...
            <li><a href="../mekar/formlaki.php"><i class="icon icon-wpforms blue-text s-18"></i>Posyandu Mekar Arum 5</a>
            </li>
            <!--
