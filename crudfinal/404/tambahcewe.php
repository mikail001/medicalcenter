...
<head>
    ...
    <link rel="stylesheet" href="css/cewe/tm.css">
    <style>
        .loader {
            position: fixed;
            left: 0;
...
<br>
	...
	<form method="post" action="tambahaksicewe.php">
		<table>
		<tr>
		<div  class="login-box">
	...
	<div class="user-box">
      <input type="number" name="BeratBadan" required="">
      <label>Berat Badan</label>
    </div>
	<div class="user-box">
      <input type="number" name="TinggiBadan" required="">
      <label>Tinggi Badan</label>
    </div>
	<div class="user-box">
      <input type="number" name="LingkarKepala" required="">
