...
<aside class="main-sidebar fixed offcanvas shadow">
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="formlaki.php"><i class="icon icon-wpforms green-text s-18"></i>Data Anak Laki-Laki</a>
            </li>
            ...
            <li><a href="exportpage.php" target=”_blank”><i class="icon icon-file-excel-o green-text s-18"></i>Export Data Anak Laki-Laki</a>
            </li>
            <li><a href="exportpagecewe.php" target=”_blank”><i class="icon icon-file-excel-o red-text s-18"></i>Export Data Anak Perempuan</a>
        </ul>
    </section>
</aside>
...
<div class="page has-sidebar-left height-full">
    <header class="blue accent-3 relative nav-sticky">
        <div class="container-fluid text-white">
            ...
            <a href="tambahcewe.php" style="font-size:x-large">+ TAMBAH DATA</a>
	...
	<table class="table table-striped table-hover r-0 data-tables">
		...
		include 'koneksi.php';
		$no = 1;
		$data = mysqli_query($koneksi,"select * from perempuan");
		while($d = mysqli_fetch_array($data)){
            ...
            <td><?php echo $no++; ?></td>
				...
				<td>
					<a href="editcewe.php?id=<?php echo $d['id']; ?>">EDIT</a>
					<a href="hapuscewe.php?id=<?php echo $d['id']; ?>">HAPUS</a>
				</td>
			</tr>
			<?php 
		}
