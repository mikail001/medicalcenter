...
<head>
    ...
    <link rel="stylesheet" href="css/cewe/edit.css">
    <style>
        .loader {
            position: fixed;
            left: 0;
...
<div class="page has-sidebar-left height-full">
	...
	$data = mysqli_query($koneksi,"select * from perempuan where id='$id'");
	 

	while($d = mysqli_fetch_array($data)){
		
		?>
		<form method="post" action="editaksicewe.php">
			<table>
				<tr>
				<td></td>
					<td>
    ...
    <div class="user-box">
      <input type="number" name="BeratBadan" value="<?php echo $d['BeratBadan']; ?>">
      <label>Berat Badan</label>
    </div>
    
    
    <div class="user-box">
      <input type="number" name="TinggiBadan" value="<?php echo $d['TinggiBadan']; ?>">
      <label>Tinggi Badan</label>
    </div>


    <div class="user-box">
      <input type="number" name="LingkarKepala" value="<?php echo $d['LingkarKepala']; ?>">
