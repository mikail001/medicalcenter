...
<aside class="main-sidebar fixed offcanvas shadow">
    <section class="sidebar">
            ...
            <div class="user-panel p-3 light mb-2">
                <div>
                    ...
                    <div class="float-left info">
                        <h6 class="font-weight-light mt-2 mb-1">User</h6>
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="exportpage.php" target=”_blank”><i class="icon icon-file-excel-o blue-text s-18"></i>Export Data Mekar Arum 18</a>
...
<div class="page has-sidebar-left height-full">
	...
	<table class="table table-striped table-hover r-0 data-tables">
		...
		include 'koneksi.php';
		$no = 1;
		$data = mysqli_query($koneksi,"select * from mekar18");
